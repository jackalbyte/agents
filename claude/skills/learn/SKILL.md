---
name: learn
description: Update local AGENTS.md/CLAUDE.md with strategic knowledge discovered during this session. Use when user says "learn", "save knowledge", "update agents.md", "update claude.md", "capture learnings", or at end of significant work sessions. Also used by commit skill for pre-commit knowledge capture.
allowed-tools: Read, Edit, AskUserQuestion
---

# Learn

Review the current conversation history and identify strategic, reusable project knowledge that should be captured in the local AGENTS.md/CLAUDE.md(depends on which exists) file.
