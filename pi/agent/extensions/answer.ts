 ...
 *
 * Source https://github.com/mitsuhiko/agent-stuff/blob/main/extensions/answer.ts
 */
...
const FREE_MODEL_ID = "gpt-5-mini";
...
async function selectExtractionModel(
	...
	// const freeModel = modelRegistry.find("anthropic", FREE_MODEL_ID);
	// if (freeModel) {
	//        const auth = await modelRegistry.getApiKeyAndHeaders(freeModel);
	//        if (auth.ok) {
	//            return freeModel;
	//        }
	// }
